...
NUM_INDIRECT_JUMPS=$(objdump -d $BINARY | grep -E 'jmp\*|call\*' | wc -l)
#echo "Number of Indirect Jumps: $NUM_INDIRECT_JUMPS"

# Entropy of the binary
ENTROPY=$(ent $BINARY | grep 'Entropy' | awk '{print $3}')
#echo "Entropy of the Binary: $ENTROPY"
...
MEMORY_ACCESS=$(valgrind --tool=memcheck $BINARY 2>&1 | grep 'total heap usage' | awk '{print $5 " allocations, " $8 " frees"}')
#echo "Memory Access Patterns: $MEMORY_ACCESS"
